...
namespace CursoProvimad0.Controllers
{
    public class SuppliersController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var mapper = MvcApplication.MyMapperConfiguration.CreateMapper();
            List<SupplierViewModel> vm = mapper.Map<List<Supplier>, List<SupplierViewModel>>(list);
            return View(vm);
        }
